...
public class BinaryNode<T> {
	...
	private T data;  //portion of node that contains data
	...
	public T getData() {  //gets data of node in question
		return data;
	}
	public void setData(T newData) {  //sets data in node to something else
		data = newData;
	}
